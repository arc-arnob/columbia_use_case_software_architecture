...
public class RentalSchema extends AbstractEntitySchema<Long> {
  ...
  private BaseLocationSchema rentalCompany;
  ...
  public RentalSchema(Rental rental) {
    ...
    this.rentalCompany = new BaseLocationSchema(rental.getRentalCompany());
  ...
  public BaseLocationSchema getRentalCompany() {
    return rentalCompany;
  }

  public void setRentalCompany(BaseLocationSchema rentalCompany) {
